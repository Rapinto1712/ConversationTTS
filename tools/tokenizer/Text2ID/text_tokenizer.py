...
class TextTokenizer(AbsTokenizer):
    def __init__(self, checkpoint_dir: Union[Path, str], max_length=1000) -> None:
...
if __name__ == "__main__":
    tx_tokenizer = TextTokenizer('/data6/ydc/exp_data/checkpoints/Qwen/Qwen2.5-0.5B')
    print(tx_tokenizer.tokenize('云再黑风再吼'))
